...
const Footer = () => {
    ...
    const inputValidation = (data: FormData) => {
        ...
        if (!data.message.trim()) {
            ...
            newErrors.message='Mensagem precisa ter mais que 10 caracteres';
        }
        ...
        <div className='footer-container'>
            ...
            <div className='footer-form'>
                ...
                <form className='contact-form' onSubmit={handleSubmit}>
                    <label htmlFor='name'>Nome* {errors.name && <span>{errors.name}</span>}</label>
                    ...
                    <label htmlFor='phone'>Telefone* {errors.phone && <span>{errors.phone}</span>}</label>
                    <input name='phone' value={formData.phone} id='phone' type="text" onChange={handleChange}/>
                    <label htmlFor='message'>Mensagem* {errors.message && <span>{errors.message}</span>}</label>
